    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <div class="input-group">
                ...
                <form action="../ui-gestisci/aggiunta_cliente.php" method="POST" style="display: inline;">&nbsp;
                    <input type="hidden" name="action" value="addCliente"> <!-- Campo nascosto per controllare l'azione nel backend -->
                    <button type="submit" class="btn btn-sm btn-outline-dark">
                        <i class="fa-solid fa-plus"></i>&nbsp; Aggiungi Nuovo Cliente
                    </button>
                </form>
            </div>
        </div>
