...
// Funzione per copiare ricorsivamente tutti i file e le cartelle
...
// Copia TUTTI i file dalla directory estratta al progetto
copyFiles($extractedDir, $projectDir);

// Elimina la directory temporanea
exec("rm -rf $tempDir");

$stato_installazione = "Installazione completata con successo.";
error_log($stato_installazione);
?>
...
<head>
    ...
    <link rel="shortcut icon" href="https://www.linkbay.it/static/image/cms-hero.png" type="image/x-icon">
...
<body>
    <div class="card bg-light text-dark w-25">
        <div class="card-header text-center">
            <img src="https://www.linkbay.it/static/image/linkbay_logo.png" width="150px" alt="">
            <br><br>
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center">
                <div id="loadingDiv" class="col-12 d-flex justify-content-center align-items-center">
                    <img id="loadingImage" src="https://www.linkbay.it/static/image/cms-hero.png" alt="Loading">
                </div>
            </div>
            <br>
            <div class="progress">
    ...
    <script>
        ...
        function startLoading() {
            updateProgressBar(25, 10, 'Download dei pacchetti', () => {
                updateProgressBar(50, 5, 'Estrazione dei file', () => {
                    updateProgressBar(99, 10, 'Installazione...', () => {
                        updateProgressBar(100, 5, '<?php echo $stato_installazione; ?>', () => {
                            setTimeout(() => {
                                window.location.href = 'install_likbay/';
                            }, 5000);
                        });
                    });
                });
