...
<head>
    ...
    <title>LinkBay - Visualizza ordine</title>
    <?php include '../materials/head_content.php'; ?>
</head>
<body style="background-color: #f1f1f1;">

    <?php echo mostraDettagliOrdine($idOrdine); ?>
...
<script>
    ...
    function closeAndRefresh() {
        if (window.opener && !window.opener.closed) {
            window.opener.location.href = '../ui/ordini_inevasi.php'; // Aggiorna la pagina genitore
        }
