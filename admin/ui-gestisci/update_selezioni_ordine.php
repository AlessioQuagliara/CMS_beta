...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['action'] == 'toggleAllSelected') {
    ...
    $checkQuery = "SELECT selected FROM ordini WHERE stato_ordine = '$whichPage' LIMIT 1";
    ...
    $updateQuery = "UPDATE ordini SET selected='$newState' WHERE stato_ordine = '$whichPage'";
