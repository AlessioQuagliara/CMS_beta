...
<head>
    ...
    <title>LinkBay - Spedizioni</title>
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="input-group">
            ...
            <form action="../ui-gestisci/aggiunta_spedizione.php" method="POST" style="display: inline;">&nbsp;
                <input type="hidden" name="action" value="addSpedizione"> <!-- Campo nascosto per controllare l'azione nel backend -->
                <button type="submit" class="btn btn-sm btn-outline-dark">
                    <i class="fa-solid fa-plus"></i>&nbsp; Aggiungi Spedizione
                </button>
            </form>
        </div>
    </div>
...
<script>
    ...
    function apriModifica(idSpedizione) {
        // Apri una nuova finestra con l'URL desiderato e specifica le dimensioni
        window.open('../ui-gestisci/spedizione_modifica.php?id=' + idSpedizione, 'ModificaSpedizione', <?php echo $resolution;?>);
    }
